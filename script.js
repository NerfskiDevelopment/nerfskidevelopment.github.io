window.onload = function(){ //Setting game size after window has loaded, or else the unityContainer will be null.
  ...
  var gameHeight = window.screen.height * .7 ; //Setting game height to 70% of the users screen height.  I don't show the full amount so that they don't think it's true full screen and they know a website is below.
